...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
       ...
       add(image);
        ...
        questions[9][0] = "JDK stands for?";
        questions[9][1] = "java development kit";
        questions[9][2] = "java device kit";
        questions[9][3] = "java dev kiit";
        ...
        answers[9][1] = "java development kit";
